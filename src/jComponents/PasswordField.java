...
public class PasswordField extends JPasswordField {
    ...
    private Image eyeHideIcon = new ImageIcon(getClass().getResource("/images/eye_hide.png")).getImage();
	private Image eyeIcon = new ImageIcon(getClass().getResource("/images/eye.png")).getImage();
    ...
    public void hideUnhideCursor() {
    	
    	addMouseMotionListener(new MouseMotionAdapter() {
			public void mouseMoved(MouseEvent e) {
				int x = getWidth() - 30;
				if(new Rectangle(x, getHeight() - 30 - spaceHelperText, 30, 30).contains(e.getPoint())) {
